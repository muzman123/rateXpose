...
import { MobilePlanFilters } from '@/lib/hooks/useMobilePlans';
...
const providers = ['Bell', 'Rogers', 'Telus', 'Fido', 'Koodo', 'Freedom', 'Chatr', 'Fizz', 'Eastlink'];
          ...
          <div className="flex flex-wrap gap-4 items-center">
            <div className="flex items-center space-x-2">
              ...
              <select 
                ...
                onChange={(e) => updateFilters({ sortBy: e.target.value as MobilePlanFilters['sortBy'] })}
              >
            ...
            <div className="flex items-center space-x-2">
              ...
              <select 
                ...
                onChange={(e) => updateFilters({ dataRange: e.target.value as MobilePlanFilters['dataRange'] })}
              >
                <option value="all">All Data Amounts</option>
                <option value="0-5">0-5GB</option>
                <option value="5-10">5-10GB</option>
                <option value="10-20">10-20GB</option>
